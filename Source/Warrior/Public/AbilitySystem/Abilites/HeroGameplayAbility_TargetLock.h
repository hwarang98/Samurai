...
public:
	...
	AActor* GetLockedTarget() const { return CurrentLockedActor; }
...
private:
	...
	void InitializeTargetLockInputSubsystem(UEnhancedInputLocalPlayerSubsystem*& SubSystem);
